package com.maxiannicu.pomodoro.widgets;
...
public class CircleProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            text = typedArray.getString(R.styleable.CircleProgressBar_progressText);
            textColor = typedArray.getInt(R.styleable.CircleProgressBar_progressTextColor,textColor);
            textSize = typedArray.getDimension(R.styleable.CircleProgressBar_progressTextSize,textSize);
        } finally {
            typedArray.recycle();
        }
